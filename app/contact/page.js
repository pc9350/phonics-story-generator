        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          >
            <div className="bg-yellow-100 dark:bg-yellow-900 rounded-3xl shadow-xl p-6">
              <h2 className="text-2xl font-bold mb-4 text-yellow-800 dark:text-yellow-200">Fun Facts About Us</h2>
              <ul className="list-disc list-inside space-y-2 text-yellow-700 dark:text-yellow-300">
                <li>We've helped over 10,000 kids learn to read!</li>
                <li>Our team includes former kindergarten teachers.</li>
                <li>We have a office dog named Phonics who loves to listen to stories.</li>
              </ul>
            </div>

            <div className="bg-green-100 dark:bg-green-900 rounded-3xl shadow-xl p-6">
              <h2 className="text-2xl font-bold mb-4 text-green-800 dark:text-green-200">Get in Touch</h2>
              <ul className="space-y-4">
                <li className="flex items-center">
                  <Phone className="mr-2 text-green-600 dark:text-green-400" />
                  <span className="text-green-700 dark:text-green-300">+918178448183</span>
                </li>
                <li className="flex items-center">
                ...
                <li className="flex items-center">
                  ...
                  <span className="text-green-700 dark:text-green-300">Delhi, India</span>
                </li>
              </ul>
            </div>

            <div className="bg-blue-100 dark:bg-blue-900 rounded-3xl shadow-xl p-6">
              <h2 className="text-2xl font-bold mb-4 text-blue-800 dark:text-blue-200">Our Office Mascot</h2>
              <div className="flex items-center justify-center">
                ...
                <p className="ml-4 text-blue-700 dark:text-blue-300">Meet Phonics, our lovable office dog!</p>
              </div>
            </div>
          </motion.div>
        </div>
